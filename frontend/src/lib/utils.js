...
// Legacy category and location constants (for backward compatibility)
// Components should fetch from API instead
export const CATEGORIES = {
  steel: {
    name_en: "Steel Utensils",
    name_np: "स्टिल भाँडा",
    icon: "pot-steaming",
    color: "#6B7280",
  },
  brass: {
    name_en: "Brass & Religious",
    name_np: "पीतल/पूजा",
    icon: "lamp",
    color: "#D4AF37",
  },
  plastic: {
    name_en: "Plastic Items",
    name_np: "प्लास्टिक",
    icon: "cup-soda",
    color: "#3B82F6",
  },
  electric: {
    name_en: "Electric Items",
    name_np: "बिजुली",
    icon: "zap",
    color: "#F59E0B",
  },
  cleaning: {
    name_en: "Cleaning Tools",
    name_np: "सफाई",
    icon: "brush",
    color: "#10B981",
  },
